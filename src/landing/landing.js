...
function landing(props) {
    return (
        <div className='landing-container'>
            ...
            <label for='collection-screenshot' className='screenshot-label'>(This is just an example screenshot)</label>
            ...
            <label for='wishlist-screenshot' className='screenshot-label'>(This is just an example screenshot)</label>
            ...
            <label for='big-button' className='screenshot-label'>(This is a sample button)</label>
